...
|zcu104-zynqmp  		| [BSP](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-design-tools.html) Built with EDF 2025.2 |
|zcu106-zynqmp  		| [BSP](https://www.xilinx.com/support/download/index.html/content/xilinx/en/downloadNav/embedded-design-tools.html) Built with EDF 2025.2 |
...
```
make bootgen_version=xlnx_rel_v2025.2 board=zcu102-zynqmp arch=zynqmp
make bootgen_version=xlnx_rel_v2025.2 board=zcu102-zynqmp arch=zynqmp clean
make bootgen_version=xlnx_rel_v2025.2 board=zcu102-zynqmp arch=zynqmp cleanall
```
